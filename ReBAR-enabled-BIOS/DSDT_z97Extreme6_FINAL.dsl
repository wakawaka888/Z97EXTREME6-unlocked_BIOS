 ...
 *
 * Disassembly of DSDT_2024.aml
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00010ED6 (69334)
 *     Revision         0x02
 *     Checksum         0xE9
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I"
 *     OEM Revision     0x00000280 (640)
 *     Compiler ID      "INTL"
 *     Compiler Version 0x20120711 (538052369)
 */
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I", 0x00000280)
{
    /*
    ...
    OperationRegion (S4NV, SystemMemory, 0xFFFF0000, 0x03)
        ...
        Device (PCI0)
        {
            ...
            Device (LPCB)
            {
                ...
                Device (SIO1)
                {
                    ...
                    CreateWordField (CRS1, \_SB.PCI0.LPCB.SIO1._Y12._INT, IRQM)  // _INT: Interrupts
                    CreateByteField (CRS1, \_SB.PCI0.LPCB.SIO1._Y13._DMA, DMAM)  // _DMA: Direct Memory Access
                    ...
                    CreateByteField (CRS1, \_SB.PCI0.LPCB.SIO1._Y14._LEN, LEN1)  // _LEN: Length
                    ...
                    CreateWordField (CRS2, \_SB.PCI0.LPCB.SIO1._Y15._INT, IRQE)  // _INT: Interrupts
                    CreateByteField (CRS2, \_SB.PCI0.LPCB.SIO1._Y16._DMA, DMAE)  // _DMA: Direct Memory Access
                    ...
                    CreateByteField (CRS2, \_SB.PCI0.LPCB.SIO1._Y17._LEN, LEN2)  // _LEN: Length
                    CreateWordField (CRS2, \_SB.PCI0.LPCB.SIO1._Y18._MIN, IO31)  // _MIN: Minimum Base Address
                    CreateWordField (CRS2, \_SB.PCI0.LPCB.SIO1._Y18._MAX, IO32)  // _MAX: Maximum Base Address
                    CreateByteField (CRS2, \_SB.PCI0.LPCB.SIO1._Y18._LEN, LEN3)  // _LEN: Length
                    Name (CRS4, ResourceTemplate ()
                    {
                        IO (Decode16,
                            ...
                            0x00,               // Length
                            _Y1A)
                        IRQ (Edge, ActiveLow, Shared, _Y19)
                            {}
                    })
                    CreateWordField (CRS4, \_SB.PCI0.LPCB.SIO1._Y19._INT, IRQL)  // _INT: Interrupts
                    CreateWordField (CRS4, \_SB.PCI0.LPCB.SIO1._Y1A._MIN, IOHL)  // _MIN: Minimum Base Address
                    CreateWordField (CRS4, \_SB.PCI0.LPCB.SIO1._Y1A._MAX, IORL)  // _MAX: Maximum Base Address
                    CreateByteField (CRS4, \_SB.PCI0.LPCB.SIO1._Y1A._ALN, ALMN)  // _ALN: Alignment
                    CreateByteField (CRS4, \_SB.PCI0.LPCB.SIO1._Y1A._LEN, LENG)  // _LEN: Length
                ...
                Method (SIOS, 1, NotSerialized)
                {
                    ...
                    If ((Arg0 != 0x05))
                    {
                        ...
                        While (Local0)
                        {
                            Local0 = KBDT /* \_SB_.PCI0.LPCB.SIOS.KBDT */
                            Sleep (0xC8)
                            Local0 = (KBST & One)
                        }
                    }
                    ...
                    If ((Arg0 >= 0x03))
                    {
                        ...
                        ^SIO1.RGE1 = Zero
                        ^SIO1.RGE2 = Zero
                        Local0 = ^SIO1.RGE3 /* \_SB_.PCI0.LPCB.SIO1.RGE3 */
                        Sleep (0xC8)
                        If (KBFG)
                        {
                            ^SIO1.RGE0 |= 0x41
                ...
                Device (BR31)
                {
                    ...
                    Device (BR41)
                    {
                        ...
                        Method (_PRT, 0, NotSerialized)  // _PRT: PCI Routing Table
                        {
                            If (PICM)
                            {
                                Return (AR41) /* \_SB_.AR41 */
                            }

                            Return (PR41) /* \_SB_.PR41 */
                        }
                    }
    ...
    Scope (_SB.PCI0)
    {
        ...
        Method (LCRS, 2, Serialized)
        {
            ...
            CreateDWordField (RBUF, \_SB.PCI0.LCRS._Y1B._BAS, BVAL)  // _BAS: Base Address
            CreateDWordField (RBUF, \_SB.PCI0.LCRS._Y1C._INT, IRQN)  // _INT: Interrupts
            BVAL = Arg0
            IRQN = Arg1
        ...
        Device (SIRC)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                ...
                CreateDWordField (BUF1, \_SB.PCI0.SIRC._Y1D._BAS, BR01)  // _BAS: Base Address
                CreateDWordField (BUF2, \_SB.PCI0.SIRC._Y1E._BAS, BR02)  // _BAS: Base Address
                CreateDWordField (BUF3, \_SB.PCI0.SIRC._Y1F._BAS, BR03)  // _BAS: Base Address
                CreateDWordField (BUF4, \_SB.PCI0.SIRC._Y20._BAS, BR04)  // _BAS: Base Address
                CreateDWordField (BUF5, \_SB.PCI0.SIRC._Y21._BAS, BR05)  // _BAS: Base Address
                CreateDWordField (BUF6, \_SB.PCI0.SIRC._Y22._BAS, BR06)  // _BAS: Base Address
                CreateDWordField (BUF7, \_SB.PCI0.SIRC._Y23._BAS, BR07)  // _BAS: Base Address
                CreateDWordField (BUF8, \_SB.PCI0.SIRC._Y24._BAS, BR08)  // _BAS: Base Address
                CreateDWordField (BUA6, \_SB.PCI0.SIRC._Y25._BAS, BR09)  // _BAS: Base Address
                CreateDWordField (BUA7, \_SB.PCI0.SIRC._Y26._BAS, BR10)  // _BAS: Base Address
                CreateDWordField (BUFL, \_SB.PCI0.SIRC._Y27._BAS, BR11)  // _BAS: Base Address
                CreateDWordField (BUFH, \_SB.PCI0.SIRC._Y28._BAS, BR12)  // _BAS: Base Address
                BR01 = SB10 /* \SB10 */
                BR02 = SB11 /* \SB11 */
                BR03 = SB12 /* \SB12 */
                BR04 = SB13 /* \SB13 */
        ...
        Device (GPI0)
        {
            ...
            CreateDWordField (RBUF, \_SB.PCI0.GPI0._Y29._MIN, BMIN)  // _MIN: Minimum Base Address
            CreateDWordField (RBUF, \_SB.PCI0.GPI0._Y29._MAX, BMAX)  // _MAX: Maximum Base Address
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                BMIN = GPMN /* \GPMN */
                BMAX = GPMX /* \GPMX */
    ...
    Scope (_SB.PCI0.I2C0)
    {
        Device (ACD0)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                {
                    Interrupt (ResourceConsumer, Level, ActiveHigh, ExclusiveAndWake, ,, _Y2B)
                    {
                        0x00000025,
                    }
                })
                ...
                {
                    CreateByteField (IRB0, \_SB.PCI0.I2C0.ACD0._CRS._Y2A._INT, VAL1)  // _INT: Interrupts
                    VAL1 = 0x1E
                    CreateByteField (IRB1, \_SB.PCI0.I2C0.ACD0._CRS._Y2B._INT, VAL3)  // _INT: Interrupts
                    VAL3 = 0x1E
                }
        ...
        Device (ACD1)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (RBUF, ResourceTemplate ()
                {
                    ...
                    Interrupt (ResourceConsumer, Edge, ActiveLow, ExclusiveAndWake, ,, _Y2C)
                    {
                        0x00000025,
                    }
                ...
                If ((((BID == 0x80) || (BID == 0x82)) || (BID == 0x83)))
                {
                    CreateByteField (RBUF, \_SB.PCI0.I2C0.ACD1._CRS._Y2C._INT, VAL1)  // _INT: Interrupts
                    VAL1 = 0x1E
        ...
        Device (ACD2)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                Name (RBUF, ResourceTemplate ()
                {
                    ...
                    Interrupt (ResourceConsumer, Edge, ActiveHigh, ExclusiveAndWake, ,, _Y2D)
                    {
                        0x00000025,
                    }
                })
                If ((((BID == 0x80) || (BID == 0x82)) || (BID == 0x83)))
                {
                    ...
                    VAL1 = 0x2E
                    CreateByteField (RBUF, \_SB.PCI0.I2C0.ACD2._CRS._Y2D._INT, VAL3)  // _INT: Interrupts
                    VAL3 = 0x1E
                }
    ...
    Scope (_SB.PCI0.I2C1)
    {
        Device (TPL0)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                If ((((BID == 0x80) || (BID == 0x82)) || (BID == 0x83)))
                {
                    CreateByteField (SBFI, \_SB.PCI0.I2C1.TPL0._CRS._Y2E._INT, VAL4)  // _INT: Interrupts
                    VAL4 = 0x1F
                }
        ...
        Device (TPL1)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                CreateByteField (SBFI, \_SB.PCI0.I2C1.TPL1._CRS._Y2F._INT, VAL4)  // _INT: Interrupts
                If ((((BID == 0x80) || (BID == 0x82)) || (BID == 0x83)))
                {
                    VAL4 = 0x1F
                }
        ...
        Device (TPL2)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                ...
                If ((((BID == 0x80) || (BID == 0x82)) || (BID == 0x83)))
                {
                    CreateByteField (IRBU, \_SB.PCI0.I2C1.TPL2._CRS._Y30._INT, VAL4)  // _INT: Interrupts
                    VAL4 = 0x1F
                }

                CreateDWordField (SBFI, \_SB.PCI0.I2C1.TPL2._CRS._Y31._SPE, I2CG)  // _SPE: Speed
                I2CG = TL2F /* \TL2F */
                If ((BID == 0x31))
                {
        ...
        Device (TPL3)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                ...
                CreateByteField (SBFI, \_SB.PCI0.I2C1.TPL3._CRS._Y32._INT, VAL4)  // _INT: Interrupts
                If ((((BID == 0x80) || (BID == 0x82)) || (BID == 0x83)))
                {
                    VAL4 = 0x1F
                }
        ...
        Device (TPD0)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                ...
                If ((GR13 == One))
                {
                    CreateByteField (SBFI, \_SB.PCI0.I2C1.TPD0._CRS._Y33._INT, VAL3)  // _INT: Interrupts
                    VAL3 = 0x1B
                }

                If ((((BID == 0x80) || (BID == 0x82)) || (BID == 0x83)))
                {
                    CreateByteField (SBFI, \_SB.PCI0.I2C1.TPD0._CRS._Y33._INT, VAL4)  // _INT: Interrupts
                    VAL4 = 0x1A
                }
        ...
        Device (TPD1)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                ...
                If ((GR13 == One))
                {
                    CreateByteField (SBFI, \_SB.PCI0.I2C1.TPD1._CRS._Y34._INT, VAL3)  // _INT: Interrupts
                    VAL3 = 0x1B
                }

                If ((((BID == 0x80) || (BID == 0x82)) || (BID == 0x83)))
                {
                    CreateByteField (SBFI, \_SB.PCI0.I2C1.TPD1._CRS._Y34._INT, VAL4)  // _INT: Interrupts
                    VAL4 = 0x1A
                }
        ...
        Device (TPD2)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                ...
                If ((GR13 == One))
                {
                    CreateByteField (SBFI, \_SB.PCI0.I2C1.TPD2._CRS._Y35._INT, VAL3)  // _INT: Interrupts
                    VAL3 = 0x1B
                }

                If ((((BID == 0x80) || (BID == 0x82)) || (BID == 0x83)))
                {
                    CreateByteField (SBFI, \_SB.PCI0.I2C1.TPD2._CRS._Y35._INT, VAL4)  // _INT: Interrupts
                    VAL4 = 0x1A
                }
        ...
        Device (TPD3)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                ...
                If ((GR13 == One))
                {
                    CreateByteField (SBFI, \_SB.PCI0.I2C1.TPD3._CRS._Y36._INT, VAL3)  // _INT: Interrupts
                    VAL3 = 0x1B
                }

                If ((((BID == 0x80) || (BID == 0x82)) || (BID == 0x83)))
                {
                    CreateByteField (SBFI, \_SB.PCI0.I2C1.TPD3._CRS._Y36._INT, VAL4)  // _INT: Interrupts
                    VAL4 = 0x1A
                }
        ...
        Device (TPD7)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                ...
                If ((GR13 == One))
                {
                    CreateByteField (SBFI, \_SB.PCI0.I2C1.TPD7._CRS._Y37._INT, VAL3)  // _INT: Interrupts
                    VAL3 = 0x1B
                    If ((S0ID == Zero))
                    {
                ...
                If ((((BID == 0x80) || (BID == 0x82)) || (BID == 0x83)))
                {
                    CreateByteField (SBFI, \_SB.PCI0.I2C1.TPD7._CRS._Y37._INT, VAL7)  // _INT: Interrupts
                    VAL7 = 0x1A
                }
        ...
        Device (TPD8)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                ...
                If ((GR13 == One))
                {
                    CreateByteField (SBFI, \_SB.PCI0.I2C1.TPD8._CRS._Y38._INT, VAL3)  // _INT: Interrupts
                    VAL3 = 0x1B
                    If ((S0ID == Zero))
                    {
                        CreateByteField (SBFI, 0x24, VAL4)
                ...
                If ((((BID == 0x80) || (BID == 0x82)) || (BID == 0x83)))
                {
                    CreateByteField (SBFI, \_SB.PCI0.I2C1.TPD8._CRS._Y38._INT, VAL7)  // _INT: Interrupts
                    VAL7 = 0x1A
                }
    ...
    Scope (_SB.PCI0.SDHC)
    {
        Device (WI01)
        {
            ...
            Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
            {
                If ((SB07 != Zero))
                {
                    CreateDWordField (RBUF, \_SB.PCI0.SDHC.WI01._Y39._LEN, WLN0)  // _LEN: Length
                    WLN0 = 0x0C
                    CreateDWordField (RBUF, \_SB.PCI0.SDHC.WI01._Y39._BAS, WVAL)  // _BAS: Base Address
                    WVAL = (SB07 + 0x1008)
                }
    ...
    Scope (_SB.PCI0)
    {
        ...
        Device (ADSP)
        {
            ...
            CreateDWordField (RBUF, \_SB.PCI0.ADSP._Y3A._BAS, B0VL)  // _BAS: Base Address
            CreateDWordField (RBUF, \_SB.PCI0.ADSP._Y3B._BAS, B1VL)  // _BAS: Base Address
            CreateDWordField (RBUF, \_SB.PCI0.ADSP._Y3C._INT, IRQN)  // _INT: Interrupts
            Name (MCLK, Zero)
            Name (SCLK, Zero)
            Name (SSPM, Zero)
            Name (ABTH, Zero)
    ...
    Scope (_SB.PCI0)
    {
        Device (PDRC)
        {
            ...
            Method (_CRS, 0, Serialized)  // _CRS: Current Resource Settings
            {
                CreateDWordField (BUF0, \_SB.PCI0.PDRC._Y3D._BAS, RBR0)  // _BAS: Base Address
                RBR0 = (^^LPCB.RCBA << 0x0E)
...
, 
    ...
    Scope (_SB.PCI0)
    {
        ...
        {
            "937308352451Genuine NVIDIA Certified SLI Ready Motherboard for ASROCK Z97 EXTREME6 ece1-Copyright 2014 NVIDIA Corporation All Rights Reserved-950249559801(R)"
        })
        Device (WMI1)
        {
